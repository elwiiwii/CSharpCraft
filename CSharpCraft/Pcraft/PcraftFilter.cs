...
public class PcraftFilter : PcraftBase, IDisposable
{
    ...
    private List<List<Button>> buttonRows = [];
    ...
    private MouseState prevState = new();
    private int camoffy;
    ...
    private void DrawDensityCheck(int index, int x, int y)
    {
        ...
        {
            Printc(SeedFilter.TileNum.FirstOrDefault(val => val.Value == tile).Key, x + 42, y + 18 + i * 6, selected && i == tileIndex && menuX == 2 ? 9 : 7);
            i++;
        }
    ...
    private void DrawDensityComparison(int index, int x, int y)
    {
        ...
        {
            Printc(SeedFilter.TileNum.FirstOrDefault(val => val.Value == tile).Key, x + 42, y + 18 + i * 6, selected1 && i == tileIndex && menuX == 2 ? 9 : 7);
            i++;
        }
        ...
        {
            Printc(SeedFilter.TileNum.FirstOrDefault(x => x.Value == tile).Key, x + 96, y + 18 + i * 6, selected1 && i == tileIndex && menuX == 5 ? 9 : 7);
            i++;
        }
