...
{
    public class SettingsScene(IScene prevScene) : IScene
    {
        ...
        public void Init(Pico8Functions pico8)
        {
            ...
            profile = new() { StartPos = (112, 93), EndPos = (124, 108), Label = "profile", ShadowTexture = "ProfileShadow", IconTexture = "ProfileIcon", Scene = new ProfileScene(prevScene) };
            settings = new() { StartPos = (111, 111), EndPos = (125, 125), Label = "settings", ShadowTexture = "SettingsShadow", IconTexture = "SettingsIcon" };
