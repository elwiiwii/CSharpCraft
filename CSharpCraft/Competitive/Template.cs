...
public class Template(IScene prevScene) : IScene
{
    ...
    public async void Init(Pico8Functions pico8)
    {
        ...
        try
        {
            ...
            profile = new() { StartPos = (112, 93), EndPos = (125, 109), Label = "profile", ShadowTexture = "ProfileShadow", IconTexture = "ProfileIcon", Scene = new ProfileScene(this, AccountHandler._myself.Username) };
