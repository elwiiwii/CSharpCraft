...
namespace CSharpCraft.Competitive
{
    public class Template : IScene
    {
        ...
        public void Init(Pico8Functions pico8)
        {
            ...
            replays = new() { StartPos = (111, 46), EndPos = (126, 60), Label = "replays", ShadowTexture = "ReplaysShadow", IconTexture = "ReplaysIcon" };
            statistics = new() { StartPos = (111, 63), EndPos = (126, 76), Label = "statistics", ShadowTexture = "StatisticsShadow", IconTexture = "StatisticsIcon" };
            search = new() { StartPos = (112, 78), EndPos = (125, 91), Label = "search", ShadowTexture = "SearchShadow", IconTexture = "SearchIcon" };
            profile = new() { StartPos = (112, 93), EndPos = (125, 109), Label = "profile", ShadowTexture = "ProfileShadow", IconTexture = "ProfileIcon" };
        ...
        public void Draw()
        {
            ...
            Icon[] icons = [back, replays, statistics, search, profile, settings];
