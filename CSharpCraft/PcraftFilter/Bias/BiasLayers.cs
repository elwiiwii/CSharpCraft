...
{
    private readonly Dictionary<(int, int), double> _coast = new();
    private readonly Dictionary<(int, int), double> _v2    = new();
    private readonly Dictionary<(int, int), double> _v3    = new();

    internal double GetCoast(int x, int y) => _coast.GetValueOrDefault((x, y));
    internal double GetV2(int x, int y)    => _v2.GetValueOrDefault((x, y));
    internal double GetV3(int x, int y)    => _v3.GetValueOrDefault((x, y));
