...
internal static class MainMenuDefs
{
    ...
    [
        ...
        new(MonoSx: 38, MonoSy: 0, MonoSw: 19, MonoSh: 17,
            ...
            Label: "casual", LabelX: 81, LabelY: 30, LabelCol: 10,
            IsEnabled: false),
        ...
        new(MonoSx: 0, MonoSy: 17, MonoSw: 15, MonoSh: 17,
            ...
            Label: "events", LabelX: 15, LabelY: 66, LabelCol: 8,
            IsEnabled: false),
        ...
        new(MonoSx: 30, MonoSy: 17, MonoSw: 23, MonoSh: 17,
            ...
            Label: "temple", LabelX: 59, LabelY: 66, LabelCol: 15,
            IsEnabled: false),
        ...
        new(MonoSx: 76, MonoSy: 0, MonoSw: 15, MonoSh: 17,
            ...
            Label: "speedrun", LabelX: 99, LabelY: 66, LabelCol: 22,
            IsEnabled: false),
        ...
        new(MonoSx: 0, MonoSy: 34, MonoSw: 15, MonoSh: 17,
            ...
            Label: "custom", LabelX: 37, LabelY: 102, LabelCol: 29,
            IsEnabled: true,
            Action: () => Pico8.ScheduleScene(() => new PcraftPreviewScene())),
        ...
        new(MonoSx: 30, MonoSy: 34, MonoSw: 15, MonoSh: 17,
            ...
            Label: "practice", LabelX: 77, LabelY: 102, LabelCol: 3,
            IsEnabled: false),
        ...
        new(MonoSx: 54, MonoSy: 65, MonoSw: 14, MonoSh: 11,
            ...
            IsEnabled: true,
            Action: () => Pico8.ScheduleScene(() => new CreditsScene())),
        ...
        new(MonoSx: 60, MonoSy: 34, MonoSw: 14, MonoSh: 14,
            ...
            IsEnabled: true,
            Action: () => Pico8.ScheduleScene(() => new SettingsScene())),
    ];
}
