...
public sealed class CameraUpdaterTests
{
    ...
    public void Update_ClampsCmxDown_WhenCmxAbovePlayerPlus16()
    {
        ...
        player.Camera.Cmx.Float.Should().BeApproximately(116f, Eps);
    }
    ...
    public void Update_DoesNotMoveCmx_WhenWithinPlayerRange()
    {
        ...
        player.Camera.Cmx.Float.Should().BeApproximately(100f, Eps);
    }

    [Fact]
    public void Update_ClampsCmy_WhenCmyOutsidePlayerRange()
    {
        var player = new PlayerEntity(F32.Zero, F32.FromInt(100));
        player.Camera.Cmy = F32.FromInt(50);

        CameraUpdater.Update(player, F32.Zero, F32.Zero);

        player.Camera.Cmy.Float.Should().BeApproximately(84f, Eps);
    }
    ...
    public void Update_AddsDxMomentum_WhenCmxFarFromPlayer()
    {
        ...
        player.Camera.Coffx.Float.Should().BeApproximately(0.36f, Eps);
    }
    ...
    public void Update_DoesNotAddDxMomentum_WhenCmxNearPlayer()
    {
        ...
        // coffx = 0 * 0.9 = 0
        player.Camera.Coffx.Float.Should().BeApproximately(0f, Eps);
    }
    ...
    public void Update_DampensCoffx_EachFrame()
    {
        ...
        player.Camera.Coffx.Float.Should().BeApproximately(0.9f, Eps);
    }
    ...
    public void Update_ClampsCoffx_ToMaxSpeed4()
    {
        ...
        player.Camera.Coffx.Float.Should().BeApproximately(4f, Eps);
    }
    ...
    public void Update_DampensCoffy_EachFrame()
    {
        ...
        player.Camera.Coffy.Float.Should().BeApproximately(0.9f, Eps);
    }
    ...
    public void Update_AdvancesClx_ByCoffx()
    {
        ...
        var player = new PlayerEntity(F32.FromInt(64), F32.Zero);
        ...
        player.Camera.Clx.Float.Should().BeApproximately(65.8f, Eps);
    }
    ...
    public void Update_ClampsClx_WhenViewportAheadOfCm()
    {
        ...
        player.Camera.Clx.Float.Should().BeApproximately(116f, Eps);
    }
