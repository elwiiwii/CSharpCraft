...
public sealed class LevelManagerPureTests(FnaFixture fixture)
{
    ...
    public void SetLevel_SetsCurrentLevel_InWorldState()
    {
        ...
        state.LevelMgr.SetLevel(level, state);
    ...
    public void AddItem_AddsExactly_CountEntities_ToList()
    {
        ...
        new LevelManager().AddItem(PcraftData.Wood, 3, F32.FromInt(32), F32.FromInt(32), entities);
    ...
    public void AddItem_SetsMaterial_AsGiveItem_OnEachEntity()
    {
        ...
        new LevelManager().AddItem(PcraftData.Stone, 2, F32.FromInt(48), F32.FromInt(16), entities);
    ...
    public void AddItem_SetsHasCol_ToTrue_OnEachEntity()
    {
        ...
        new LevelManager().AddItem(PcraftData.Wood, 2, F32.FromInt(32), F32.FromInt(32), entities);
    ...
    public void AddItem_SetsTimer_InExpectedRange_OnEachEntity()
    {
        ...
        new LevelManager().AddItem(PcraftData.Wood, 5, F32.FromInt(32), F32.FromInt(32), entities);
    ...
    public void AddItem_SpawnsWithinTileContainingHitPoint()
    {
        ...
        new LevelManager().AddItem(PcraftData.Wood, 20, F32.FromInt(32), F32.FromInt(32), entities);
...
public sealed class LevelManagerFnaTests(FnaFixture fixture)
{
    ...
    public void FillEne_SetsPlayerAsFirstEnemy_InLevelEneList()
    {
        ...
        state.LevelMgr.FillEne(level, state);
    ...
    public void CreateLevel_ReturnsLevel_WithCorrectDimensions()
    {
        ...
        var level = state.LevelMgr.CreateLevel(0, 0, 64, 64, isUnder: false, state);
